 ...
 */
public interface PathNodeVisitor<K extends BitSequence<K>, V> {
   ...
   */
  default Node<K, V> visit(InternalNode<K, V> internalNode, BitSequence<K> path) {
    return internalNode;
  }
   ...
   */
  default Node<K, V> visit(StemNode<K, V> stemNode, BitSequence<K> path) {
    return stemNode;
  }
   ...
   *
   * @param leafNode The LeafNode to visit.
   * @param path The path associated with the visit.
   * @return The result of visiting the null node.
   */
  default Node<K, V> visit(LeafNode<K, V> leafNode, BitSequence<K> path) {
    return leafNode;
  }
   ...
   * @return The result of visiting the null node.
   */
  default Node<K, V> visit(NullNode<K, V> nullNode, BitSequence<K> path) {
    return nullNode;
  }
   ...
   * @return The result of visiting the null node.
   */
  default Node<K, V> visit(NullLeafNode<K, V> nullLeafNode, BitSequence<K> path) {
    return nullLeafNode;
  }
}
